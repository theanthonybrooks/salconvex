  ...
  return (
    <div className="mx-auto mb-10 mt-8 flex h-full w-full max-w-[80vw] flex-col gap-y-3 px-4 lg:max-w-[60vw]">
        ...
        <ul className="list-disc text-sm [&>li:not(:last-of-type)]:pb-3 [&>li]:ml-8">
          ...
          <li>
            <p className="text-sm">
              ...
              in this Agreement) refers to The Street Art List.
            </p>
          </li>
          <li>
            <p className="text-sm">
      ...
      <section className="flex flex-col gap-y-2">
        ...
        <p className="text-sm">
          The Company allows You to link and log in to use the Service through
        ...
        <ul className="list-disc text-sm [&>li:not(:last-of-type)]:pb-3 [&>li]:ml-8">
          ...
          <li>
            <strong>With project organizers:</strong> We may share Your
            information with Our associated project managers when it is
            necessary to do so in order to complete the project application
            process. This will only take place following Your expressed
            approval, with Your knowledge, and/or as a result of your actions .
          </li>
          <li>
      ...
      <section className="flex flex-col gap-y-2">
        ...
        <p className="text-sm">
          ...
          posted on this page. An effort will be made to notify users by email
          of any changes
        </p>
      </section>
      <section className="flex flex-col gap-y-2 text-center">
        <h2 className="mt-5 text-center text-xl font-bold">Contact Us</h2>
        <p className="text-sm">
