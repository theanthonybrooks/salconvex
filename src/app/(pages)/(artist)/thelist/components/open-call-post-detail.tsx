...
interface OpenCallPostDetailProps {
...
const OpenCallPostDetail = ({ data }: OpenCallPostDetailProps) => {
  ...
  return (
    <div
      className={cn(
        "my-10 flex w-full flex-col justify-items-center lg:grid lg:grid-cols-2",
      )}
    >
      <section className={cn("flex flex-col gap-3")}>
        <p>Social Media Post</p>
        <div className="relative flex h-[625px] w-[500px] flex-col rounded-sm border-3">
          <section
            className={cn(
              "flex items-center justify-between px-10 pt-6 font-semibold uppercase",
            )}
          >
            <p>{locationString}</p>
            <EventDates
          ...
          <section
            className={cn(
              "divide-y-2.5 border-2.5 mx-10 mb-10 flex flex-1 flex-col overflow-hidden rounded-b-sm rounded-t-3xl",
            )}
          >
            <div className={cn("divide-x-2.5 flex items-center")}>
              {" "}
              <span className="font-acumin flex-1 text-center text-3xl font-bold uppercase">
                {event.name}
              </span>
              <div
                className={cn(
                  "flex h-[150px] items-center justify-center bg-foreground p-3",
                )}
              >
                <Image
            ...
            <div className={cn("flex w-full flex-col gap-1 bg-card px-6 py-4")}>
              {" "}
              <p className="font-acumin text-sm uppercase">
                Application Deadline:
              </p>
              <p className="font-acumin text-6xl font-[725] uppercase">
            ...
            <div className={cn("divide-x-2.5 flex h-full items-stretch")}>
              ...
              <div className="font-acumin flex flex-col items-center justify-center px-4 py-2 uppercase">
                ...
                <span
                  className={cn("flex flex-col items-center leading-[0.8]")}
                >
            ...
            <div
              className={cn(
                "divide-x-2.5 flex h-max items-center bg-foreground",
              )}
            >
              <div
                className={cn(
...
export default OpenCallPostDetail;
