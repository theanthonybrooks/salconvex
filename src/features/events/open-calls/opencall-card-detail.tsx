...
const OpenCallCardDetail = (props: OpenCallCardDetailProps) => {
  ...
  return (
    <>
      ...
      {/* //---------------------- Desktop Layout ---------------------- */}
      <Card className="mb-10 hidden w-full min-w-[340px] max-w-[400px] grid-cols-[75px_auto] gap-x-3 rounded-3xl border-foreground/20 bg-white/50 p-3 first:mt-6 lg:grid">
        {status !== null && !manualApplied && (
          <span
            className={cn(
              "col-start-2 w-fit rounded-full border-2 border-foreground/30 bg-white/70 px-2 py-1 text-xs",
