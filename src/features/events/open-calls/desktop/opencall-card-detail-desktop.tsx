  ...
  return (
    <div className="grid w-full max-w-[min(90vw,1400px)] grid-cols-[250px_auto] gap-x-6 pb-10 lg:grid-cols-[300px_auto]">
      <>
        <Card
          className={cn(
            "mb-10 mt-[6px] hidden w-full max-w-[350px] grid-cols-[75px_auto] gap-x-3 rounded-3xl border-foreground/20 bg-white/50 p-3 first:mt-6 lg:grid",
            className,
          )}
        >
      ...
      <div className="flex w-full flex-col items-start gap-y-2">
        ...
        <Card className="w-full rounded-3xl border-foreground/20 bg-white/50 p-4 pt-8">
          <NavTabs tabs={tabList} className="col-start-2">
            <div id="openCall">
              <Card
                className={cn(
