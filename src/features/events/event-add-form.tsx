      ...
      <FormProvider {...form}>
        ...
        >
          {activeStep === 0 && (
            ...
            //         To start, select from an existing organization or create a
            //         new one!
            //       </p>
            //     </section>
            //     <div
              ...
              {hasEventLocation && (
                <>
                  ...
                  >
                    ...
                    {/* <div className="mx-auto flex w-full max-w-sm flex-col gap-2 lg:min-w-[300px] lg:max-w-md">
                      <Label
                        htmlFor="event.dates.prodFormat"
                        className="sr-only"
                      >
                      ...
                      {eventData?.dates?.prodFormat && (
                        <div className="mx-auto flex w-full max-w-sm flex-col gap-2 lg:min-w-[300px] lg:max-w-md">
                          ...
                          <div className="flex items-center gap-x-2">
                            <Controller
                              name="event.dates.prodDates.0.start"
                              control={control}
                              render={({ field }) => {
                                return (
                                  <Input
                            ...
                            -
                            <Controller
                              name="event.dates.prodDates.0.end"
                              control={control}
                              render={({ field }) => {
                                return (
                                  <Input
