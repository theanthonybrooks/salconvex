...
>(
  (
    ...
    <SelectPrimitive.Item
      ref={ref}
      className={cn(
        "outline-hidden data-disabled:pointer-events-none data-disabled:opacity-50 relative flex w-full cursor-pointer select-none items-center rounded-sm py-2 pl-2 text-base focus:bg-salPinkLt focus:text-accent-foreground data-[state=checked]:bg-salPinkLt/50 data-[state=checked]:font-bold sm:py-1.5 sm:text-sm",
