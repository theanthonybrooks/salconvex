  ...
  (
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute size-10 rounded-full border-0 hover:scale-110 hover:bg-background disabled:opacity-0",
          orientation === "horizontal"
            ? "top-1/2 -translate-y-1/2"
            : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
          inset && orientation === "horizontal" && "left-10",
          !inset && orientation === "horizontal" && "-left-12",
          className,
        )}
    ...
    return (
      <Button
        ...
        className={cn(
          ...
          inset && orientation === "horizontal" && "right-10",
          !inset && orientation === "horizontal" && "-right-12",
