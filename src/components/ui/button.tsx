  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium  transition-colors   disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:pointer-events-none ",
  {
    variants: {
      variant: {
        ...
        salWithShadowYlw: `bg-salyellow text-foreground border-2 hover:bg-salYellowLt hover:shadow-slgHover hover:translate-x-[-1px] border-foreground font-medium shadow-slg transition-all duration-300 linear  active:shadow-none active:translate-x-[-3px] active:translate-y-[3px] dark:border-primary-foreground dark:text-primary-foreground `,
        ...
        salWithShadowPink: `bg-salPink hover:shadow-slgHover hover:bg-salPinkLt hover:translate-x-[-1px] text-foreground border-2 border-foreground font-medium shadow-slg transition-all duration-300 linear  active:shadow-none active:translate-x-[-3px] active:translate-y-[3px]  dark:border-primary-foreground dark:text-primary-foreground `,
      },
      size: {
