  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium  transition-colors   disabled:pointer-events-none disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:pointer-events-none ",
  {
    variants: {
      variant: {
        ...
        salWithShadow: `bg-white text-foreground border-2 border-foreground font-medium shadow-slg transition-all duration-300 linear hover:shadow-slgHover hover:translate-x-[-1px] focus:translate-x-[-1px] focus:shadow-slgHover  active:shadow-none active:translate-x-[-3px] active:translate-y-[3px]   dark:border-primary-foreground dark:text-primary-foreground `,
        ...
        salWithoutShadow: `bg-white text-foreground  hover:bg-salYellow/80 active:bg-salYellow/70 border-2 border-foreground focus:bg-salyellow/70 dark:border-primary-foreground dark:text-primary-foreground `,
        salWithShadowYlw: `bg-salyellow text-foreground border-2 hover:bg-salYellowLt hover:shadow-slgHover hover:translate-x-[-1px] border-foreground font-medium shadow-slg transition-all duration-300 linear  active:shadow-none active:translate-x-[-3px] active:translate-y-[3px] dark:border-primary-foreground dark:text-primary-foreground focus:translate-x-[-1px] focus:shadow-slgHover focus:bg-salYellowLt `,
        salWithShadowHiddenYlw: `bg-salYellow  text-foreground border-2 border-foreground font-medium shadow-none transition-all duration-300 linear hover:shadow-slg hover:translate-x-[3px] hover:translate-y-[-3px] active:shadow-none active:translate-x-0 active:translate-y-0  dark:border-primary-foreground dark:text-primary-foreground white:bg-white`,
        salWithShadowPink: `bg-salPink hover:shadow-slgHover hover:bg-salPinkLt hover:translate-x-[-1px] text-foreground border-2 border-foreground font-medium shadow-slg transition-all duration-300 linear  active:shadow-none active:translate-x-[-3px] active:translate-y-[3px]  dark:border-primary-foreground dark:text-primary-foreground focus:translate-x-[-1px] focus:shadow-slgHover focus:bg-salPinkLt `,
      },
      size: {
        default: "h-13 sm:h-11 px-4 py-2 text-base sm:text-sm",
        sm: "h-9 rounded-md px-3",
        lg: "h-14 sm:h-11 rounded-md px-6 sm:px-8 text-base sm:text-sm",
        icon: "h-10 w-10",
        richText: "h-auto p-1",
        link: "h-auto p-0",
      },
